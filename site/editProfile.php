		...
		<?php
			...
			if(!isset($_SESSION['email'])){
				...
				if ($_SERVER['REQUEST_METHOD'] == "POST" && (isset($_POST['Submit']))) {
					...
					//echo $Language3, "</br>";
					//echo $Ranking;
					$sql="UPDATE user SET name='$Name',surname='$Surname',Gender='$Gender',nationality='$National',
					city='$City',avatar='$Avatar',Expertise='$Expertise',Position='$Position',BusinessP1='$BusinessP1',BusinessP2='$BusinessP2',BusinessP3='$BusinessP3',
					company='$Company',job='$Job',degree1='$Studies1',degree2='$Studies2',degree3='$Studies3',language1='$Language1',language2='$Language2',language3='$Language3',
					Rank='$Ranking'WHERE email='$email'";
					//$retval = mysql_query( $sql);
					$retval = $linkDB->query($sql);
